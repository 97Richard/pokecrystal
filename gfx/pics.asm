...
; Sections "gfx/pics@Pics 20" to "gfx/pics.asm@Pics 24" are not used for any graphics,
; but entries for their banks exist in FixPicBank (see engine/gfx/load_pics.asm).

SECTION "gfx/pics@Pics 20", ROMX

SECTION "gfx/pics@Pics 21", ROMX

SECTION "gfx/pics@Pics 22", ROMX

SECTION "gfx/pics@Pics 23", ROMX

SECTION "gfx/pics@Pics 24", ROMX
