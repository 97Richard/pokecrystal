...
maps_PlayersHouse1F_o_TVScript:
	jumptext maps_PlayersHouse1F_o_TVText
...
PlayersHouse1F_MapEvents::
	...
	bg_event  4,  1, BGEVENT_READ, maps_PlayersHouse1F_o_TVScript
