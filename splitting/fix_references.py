...
predefs = set()
for line in open(join(args.prefix, "data", "predef_pointers.inc")):
    if line.startswith("\tadd_predef "):
        predefs.add(line.strip().split(" ")[1].strip() + "Predef")

specials = set()
for line in open(join(args.prefix, "data", "special_pointers.inc")):
...
for symbol in refs["Tilesets"]:
    ...
    if symbol.endswith("PalMap"):
        refs["Tilesets"][symbol] = True
        refs["_SwapTextboxPalettes"][symbol] = False
        refs["_ScrollBGMapPalettes"][symbol] = False
...
refs["PlayMusic"]["_InitSound"] = True
refs["_PlayMusic"]["_InitSound"] = False
...
# This table isn't referenced through BANK() here...
refs["GetMart"]["Marts"] = False

# Fallthrouhgs
refs["ReadPartyMonMail"]["ReadAnyMail"] = False
refs["StatsScreen_LoadFont"]["LoadStatsScreenPageTilesGFX"] = False
refs["HandleNewMap"]["HandleContinueMap"] = False
...
# SPLIT: Crystal bank
refs["Function4a0c2"]["InitMobileProfile"] = True
refs["InitMobileProfile"]["Function4a3a7"] = True
refs["InitMobileProfile"]["GetMysteryGift_MobileAdapterLayout"] = True
refs["Function48689"]["GetMysteryGift_MobileAdapterLayout"] = True
refs["Function4a492"]["MG_Mobile_Layout00"] = True
refs["Function4a098"]["MG_Mobile_Layout_LoadPals"] = True
refs["Function4a4c4"]["Function48cdc"] = True
refs["Function4a28a"]["Function48cdc"] = True
refs["Function4a149"]["Function48cdc"] = True
refs["Function49f16"]["Function48cdc"] = True
